  ...
  return (
    ...
    <div className="cart-container">
      <div className="cart-header">
        ...
        <Button type='button' className="cart-clear" children={'Очистить корзину'}></Button>
      </div>
      <div className="cart-box">
        <div className="cart-state">
          <span className="cart-state-title">Xiaomi</span>          
          <span className="cart-state-total">Стоимость корзины: 1185000Р</span>
          <Button type='link' linkTo={'/delivery'} className="cart-state-button" children={'Оформить'}></Button>
